...
const saveLocal = () => {
  ...
  categoryTitleElement.textContent = categoryToDisplay;
  let selectedCategory = categories[0];
  // Filter tasks based on the category and render them
  const filteredTasks = tasks.filter(task => task.category.toLowerCase() === categoryToDisplay);
